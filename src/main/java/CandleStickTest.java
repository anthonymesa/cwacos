...
class AdvCandleStickChart extends Pane {
     ...
     */
    private static class CandleStickChart extends XYChart<Number, Number> {
     ...
     */
    private static class CandleStickExtraValues {
 ...
 */
class Ensemble_AdvCandleStickChart extends Application {
