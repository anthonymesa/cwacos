...
public class Cwacos {
    public static void main(String[] args) {
        ...
        data.save(new ArrayList<String>(Arrays.asList("res/data.txt")), AlphaVantageAPITranslator.getStockInfo("IBM", AlphaAPIDataGet.INTRADAY_CALL, AlphaAPIDataGet.MINUTE_5));
