...
public class MonthlyAPI extends AbstractAPI{
    /**
     * Creates connection to API, stores Monthly JSON, parses Monthly JSON, and returns monthly data organized in an ArrayList of Entry Objects.
     ...
     */
    public static ArrayList<Entry> getMonthlyInfo(String _stock){
        try {
            // Create the API url.
            URL url = getStockURL(_stock, null, "monthly");
            ...
            String JSONInterval = translateInterval("monthly");
